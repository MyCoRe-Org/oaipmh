...
public abstract class OAIConstants {
    ...
    public final static Namespace NS_OAI_ID = Namespace
        .getNamespace("http://www.openarchives.org/OAI/2.0/oai-identifier");

    public final static Namespace NS_OAI_FRIENDS = Namespace
        .getNamespace("http://www.openarchives.org/OAI/2.0/friends/");

    public final static Namespace NS_OAI_DC = Namespace.getNamespace("oai_dc",
